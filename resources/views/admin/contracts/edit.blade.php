                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="due_date" class="select2">
                                                <option value="1" {{ (old('due_date') == 1 ? 'selected' : ($contract->due_date == 1 ? 'selected' : '')) }}>
                                                    1º
                                                </option>
                                                <option value="2" {{ (old('due_date') == 2 ? 'selected' : ($contract->due_date == 2 ? 'selected' : '')) }}>
                                                    2/mês
                                                </option>
                                                <option value="3" {{ (old('due_date') == 3 ? 'selected' : ($contract->due_date == 3 ? 'selected' : '')) }}>
                                                    3/mês
                                                </option>
                                                <option value="4" {{ (old('due_date') == 4 ? 'selected' : ($contract->due_date == 4 ? 'selected' : '')) }}>
                                                    4/mês
                                                </option>
                                                <option value="5" {{ (old('due_date') == 5 ? 'selected' : ($contract->due_date == 5 ? 'selected' : '')) }}>
                                                    5/mês
                                                </option>
                                                <option value="6" {{ (old('due_date') == 6 ? 'selected' : ($contract->due_date == 6 ? 'selected' : '')) }}>
                                                    6/mês
                                                </option>
                                                <option value="7" {{ (old('due_date') == 7 ? 'selected' : ($contract->due_date == 7 ? 'selected' : '')) }}>
                                                    7/mês
                                                </option>
                                                <option value="8" {{ (old('due_date') == 8 ? 'selected' : ($contract->due_date == 8 ? 'selected' : '')) }}>
                                                    8/mês
                                                </option>
                                                <option value="9" {{ (old('due_date') == 9 ? 'selected' : ($contract->due_date == 9 ? 'selected' : '')) }}>
                                                    9/mês
                                                </option>
                                        ...
                                        <label class="label">
                                            ...
                                            <select name="deadline" class="select2">
                                                <option value="12" {{ (old('deadline') == 12 ? 'selected' : ($contract->deadline == 12 ? 'selected' : '')) }}>
                                                    12 meses
                                                </option>
                                                <option value="24" {{ (old('deadline') == 24 ? 'selected' : ($contract->deadline == 24 ? 'selected' : '')) }}>
                                                    24 meses
                                                </option>
                                                <option value="36" {{ (old('deadline') == 36 ? 'selected' : ($contract->deadline == 36 ? 'selected' : '')) }}>
                                                    36 meses
                                                </option>
                                                <option value="48" {{ (old('deadline') == 48 ? 'selected' : ($contract->deadline == 48 ? 'selected' : '')) }}>
                                                    48 meses
                                                </option>
                                            </select>
                                        </label>
