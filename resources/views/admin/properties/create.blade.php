            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('admin.properties.index') }}" class="text-orange">Imóveis</a>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <form action="{{ route('admin.properties.store') }}" method="post" class="app_form"
                    ...
                    <div class="nav_tabs_content">
                                ...
                                <label class="label">
                                    ...
                                    <select name="type" class="select2">
                                        ...
                                        <optgroup label="Imóvel Residencial">
                                            <option value="Casa" {{ (old('type') == 'Casa' ? 'selected' : '') }}>
                                                Casa
                                            </option>
                                            <option
                        ...
                        <div id="structure" class="d-none">
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="library"
                                            {{ (old('library') == 'on' || old('library') == true ? 'checked' : '') }}>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="fitted_kitchen"
                                            {{ (old('fitted_kitchen') == 'on' || old('fitted_kitchen') == true ? 'checked' : '') }}>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="pantry"
                                            {{ (old('pantry') == 'on' || old('pantry') == true ? 'checked' : '') }}>
                                        <span>Despensa</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="edicule"
                                            {{ (old('edicule') == 'on' || old('edicule') == true ? 'checked' : '') }}>
                                        <span>Edícula</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="bathtub"
                                            {{ (old('bathtub') == 'on' || old('bathtub') == true ? 'checked' : '') }}>
                                        <span>Banheira</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="fireplace"
                                            {{ (old('fireplace') == 'on' || old('fireplace') == true ? 'checked' : '') }}>
                                        <span>Lareira</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="lavatory"
                                            {{ (old('lavatory') == 'on' || old('lavatory') == true ? 'checked' : '') }}>
                                        <span>Lavabo</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="furnished"
                                            {{ (old('furnished') == 'on' || old('furnished') == true ? 'checked' : '') }}>
                                        <span>Mobiliado</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="steam_room"
                                            {{ (old('steam_room') == 'on' || old('steam_room') == true ? 'checked' : '') }}>
                                        <span>Sauna</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="view_of_the_sea"
                                            {{ (old('view_of_the_sea') == 'on' || old('view_of_the_sea') == true ? 'checked' : '') }}>
                            ...
                            <label class="label">
                                <span class="legend">*Título:
                                    <a href="" target="_blank" class="text-orange icon-link"
                                       style=" margin-left: 10px; font-size: 0.875em;">
                                        Link
                                    </a>
                                </span>
