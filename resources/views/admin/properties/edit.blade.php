                            ...
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox" name="sale"
                                        {{ (old('sale') == 'on' || old('sale') == true ? 'checked' : ($property->sale == true ? 'checked' : '')) }}>
                                    <span>Venda</span>
                                </label>

                                <label class="label">
                                    <input type="checkbox" name="rent"
                                        {{ (old('rent') == 'on' || old('rent') == true ? 'checked' : ($property->rent == true ? 'checked' : '')) }}>
                                    <span>Locação</span>
                                </label>
                            </div>
                            ...
                            <label class="label">
                                ...
                                <select name="user" class="select2">
                                    ...
                                    @foreach($users as $user)
                                        <option
                                            value="{{ $user->id }}" {{ ($user->id === $property->user ? 'selected' : '') }}>
                        ...
                        <div id="structure" class="d-none">
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="air_conditioning"
                                            {{ (old('air_conditioning') == 'on' || old('air_conditioning') == true ? 'checked' : ($property->air_conditioning == true ? 'checked' : '')) }}>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="bar"
                                            {{ (old('bar') == 'on' || old('bar') == true ? 'checked' : ($property->bar == true ? 'checked' : '')) }}>
                                        <span>Bar</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="library"
                                            {{ (old('library') == 'on' || old('library') == true ? 'checked' : ($property->library == true ? 'checked' : '')) }}>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="barbecue_grill"
                                            {{ (old('barbecue_grill') == 'on' || old('barbecue_grill') == true ? 'checked' : ($property->barbecue_grill == true ? 'checked' : '')) }}>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="american_kitchen"
                                            {{ (old('american_kitchen') == 'on' || old('american_kitchen') == true ? 'checked' : ($property->american_kitchen == true ? 'checked' : '')) }}>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="fitted_kitchen"
                                            {{ (old('fitted_kitchen') == 'on' || old('fitted_kitchen') == true ? 'checked' : ($property->fitted_kitchen == true ? 'checked' : '')) }}>
                                        <span>Cozinha Planejada</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="pantry"
                                            {{ (old('pantry') == 'on' || old('pantry') == true ? 'checked' : ($property->pantry == true ? 'checked' : '')) }}>
                                        <span>Despensa</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="edicule"
                                            {{ (old('edicule') == 'on' || old('edicule') == true ? 'checked' : ($property->edicule == true ? 'checked' : '')) }}>
                                        <span>Edícula</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="office"
                                            {{ (old('office') == 'on' || old('office') == true ? 'checked' : ($property->office == true ? 'checked' : '')) }}>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="bathtub"
                                            {{ (old('bathtub') == 'on' || old('bathtub') == true ? 'checked' : ($property->bathtub == true ? 'checked' : '')) }}>
                                        <span>Banheira</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="fireplace"
                                            {{ (old('fireplace') == 'on' || old('fireplace') == true ? 'checked' : ($property->fireplace == true ? 'checked' : '')) }}>
                                        <span>Lareira</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="lavatory"
                                            {{ (old('lavatory') == 'on' || old('lavatory') == true ? 'checked' : ($property->lavatory == true ? 'checked' : '')) }}>
                                        <span>Lavabo</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="furnished"
                                            {{ (old('furnished') == 'on' || old('furnished') == true ? 'checked' : ($property->furnished == true ? 'checked' : '')) }}>
                                        <span>Mobiliado</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="pool"
                                            {{ (old('pool') == 'on' || old('pool') == true ? 'checked' : ($property->pool == true ? 'checked' : '')) }}>
                                        <span>Piscina</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="steam_room"
                                            {{ (old('steam_room') == 'on' || old('steam_room') == true ? 'checked' : ($property->steam_room == true ? 'checked' : '')) }}>
                                        <span>Sauna</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox" name="view_of_the_sea"
                                            {{ (old('view_of_the_sea') == 'on' || old('view_of_the_sea') == true ? 'checked' : ($property->view_of_the_sea == true ? 'checked' : '')) }}>
                            ...
                            <label class="label">
                                <span class="legend">*Título: <a href="" target="_blank" class="text-orange icon-link"
                                                                 style=" margin-left: 10px; font-size: 0.875em;">Link</a>
                                </span>
