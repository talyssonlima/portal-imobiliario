            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('admin.users.create') }}" class="text-orange">Novo Cliente</a>
                        </li>
                    </ul>
                </nav>
            </div>
                            ...
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox" name="lessor"
                                        {{ (old('lessor') == 'on' || old('lessor') == true ? 'checked' : ($user->lessor == true ? 'checked' : '')) }}>
                                    <span>Locatário</span>
                                </label>

                                <label class="label">
                                    <input type="checkbox" name="lessee"
                                        {{ (old('lessee') == 'on' || old('lessee') == true ? 'checked' : ($user->lessee == true ? 'checked' : '')) }}>
                                    <span>Locador</span>
                                </label>
                            </div>
                                ...
                                <div class="app_collapse_content">
                                    <div id="realties">
                                        <div class="realty_list">
                                            @can('Listar Imóveis - Conta do Cliente')
                                                            ...
                                                            <div class="realty_list_item_content">
                                                                ...
                                                                <div class="realty_list_item_card">
                                                                    ...
                                                                    <div class="realty_list_item_card_content">
                                                                        ...
                                                                        <span class="realty_list_item_description_content">
                                                                ...
                                                                <div class="realty_list_item_card">
                                                                    ...
                                                                    <div class="realty_list_item_card_content">
                                                                        ...
                                                                        <span class="realty_list_item_description_content">
                                                                            {{ $property->bedrooms + $property->suites }} Quartos<br>
                                                                            <span>Sendo {{ $property->suites }} suítes</span>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="realty_list_item_card">
                                                                    ...
                                                                    <div class="realty_list_item_card_content">
                                                                        ...
                                                                        <span class="realty_list_item_description_content">
                                                                            {{ $property->garage + $property->garage_covered }} Vagas<br>
                                                                ...
                                                                <div>
                                                                    @if($property->sale == true && !empty($property->sale_price))
                                                                        <a href="{{ route('web.buyProperty', ['slug' => $property->slug]) }}"
                                                                           class="btn btn-blue icon-eye" target="_blank">
                                                                            Visualizar Imóvel (Compra)
                                                                        </a>
                                                                    @endif
                                                                    ...
                                                                    @if($property->rent == true && !empty($property->rent_price))
                                                                        <a href="{{ route('web.rentProperty', ['slug' => $property->slug]) }}"
                                                                           class="btn btn-blue icon-eye" target="_blank">
                                                                            Visualizar Imóvel (Locação)
                                                                        </a>
                                                                    @endif

                                                                    @can('Editar Imóvel')
                                                                        <a href="{{ route('admin.properties.edit', ['property' => $property->id]) }}"
                                                                           class="btn btn-green icon-pencil-square-o">
                                                                            Editar Imóvel
                                                                        </a>
                                                                    @endcan
                                                                </div>
                                                ...
                                                @endif
                                            @else
                                                <div class="no-content">Você não possui permissão para ver esse item!</div>
                                            @endcan
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                <div class="realty_list_item_content">
                                                                    ...
                                                                    <div class="realty_list_item_card">
                                                                        ...
                                                                        <div class="realty_list_item_card_content">
                                                                            ...
                                                                            <span
                                                                                class="realty_list_item_description_content">
                                                                                {{ $property->neighborhood }}
                                                                            </span>
                                                                        </div>
                                                                    ...
                                                                    <div class="realty_list_item_card">
                                                                        ...
                                                                        <div class="realty_list_item_card_content">
                                                                            <span
                                                                                class="realty_list_item_description_title">Dormitórios:</span>
                                                                            <span
                                                                                class="realty_list_item_description_content">
                                                                                {{ $property->bedrooms + $property->suites }} Quartos<br>
                                                                                <span>Sendo {{ $property->suites }} suítes</span>
