            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('admin.permission.index') }}" class="text-orange">Permissões</a>
                        </li>
                    </ul>
                </nav>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                @can('Editar Permissão')
                                    <a class="mr-1 btn btn-orange" href="{{ route('admin.permission.edit', ['permission' => $permission->id]) }}">
                                        Editar
                                    </a>
                                @endcan

                                @can('Remover Permissão')
